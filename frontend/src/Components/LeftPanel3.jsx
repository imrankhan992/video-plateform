...
function LeftPanel2() {
  ...
  useEffect(() => {
    ...
    if (currentUrl === `/studio/video/edit/${id}`) {
      ...
      selected = "Content";
    } else if (currentUrl === `/admin/studio/video/comments/${id}`) {
    ...
    <>
      ...
      >
        <div
          ...
          onClick={() => {
            if (window.location.href.includes(`/studio/video/edit/${id}`) || window.location.href.includes(`/admin/studio/video/edit/${id}`)) {
             user?.role === "user"
              ...
              : (window.location.href = "/admin/studio/comments");
            }
          }}
        >
        ...
        <div className="second-panel">
        {
          ...
          <div
            ...
            onClick={() => {
              ...
              (window.location.href = `/admin/studio/video/comments/${id}`)

...
function Content() {
  ...
  const videoUrl = "https://example.app/video";
  ...
  useEffect(() => {
    if (theme === false && window.location.href.includes("/admin/studio/video")) {
      document.body.style.backgroundColor = "white";
    } else if (
      theme === true &&
      window.location.href.includes("/admin/studio/video")
    ) {
      ...
      try {
        if (user?.email) {
          const response = await fetch(
            `${backendURL}/admin/getuservideos`
          );
                              ...
                              <ChatOutlinedIcon
                                ...
                                onClick={() => {
                                 user?.role === "user"
                                    ...
                                    : (window.location.href = `/admin/studio/video/comments/${element._id}`);
                                }}
                              />
                            </Tooltip>
                            <Tooltip
